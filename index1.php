    ...
    <div class="h4">
      ...
      <div class="songsPop">
         <li class="songItem">
            ...
            <div class="img_play">
                <img src="Project1/Images/1.jpg" alt="alan">
                 <i class="bi  menuBtns bi-play-circle-fill" id="16"></i>
                </div>
            <h5>On My Way <br> 
                <div class="subtitle">Alan Walker</div>
            </h5>
            ...
            <div class="img_play">
                <img src="Project1/Images/1.jpg" alt="alan">
                 <i class="bi  menuBtns bi-play-circle-fill" id="17"></i>
                </div>
            <h5>On My Way <br> 
                <div class="subtitle">Alan Walker</div>
            </h5>
            ...
            <div class="img_play">
                <img src="Project1/Images/1.jpg" alt="alan">
                 <i class="bi  menuBtns bi-play-circle-fill" id="18"></i>
                </div>
            <h5>On My Way <br> 
                <div class="subtitle">Alan Walker</div>
            </h5>
            ...
            <div class="img_play">
                <img src="Project1/Images/1.jpg" alt="alan">
                 <i class="bi  menuBtns bi-play-circle-fill" id="19"></i>
                </div>
            <h5>On My Way <br> 
                <div class="subtitle">Alan Walker</div>
            </h5>
...
<div class="master_play">
    ...
    <img src="Project1/Images/1.jpg" alt="alan" id="poster_master_play">  <!--to download and give another image-->
    <h5 id="title">
        On My Way
        <div class="subtitle">Sabrina Carpenter</div>
    </h5>
