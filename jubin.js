...
const music = new Audio ('Project1/Jubin/Audio/1.mp3');
//music.play();
...
const songs = [

    {
        ...
        poster: "Project1/Jubin/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Taaron Ke Sher Mein <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Meri Aashiqui <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Akh Lad Jave <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Tujhe Kitna Chahein Aur <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: ` Lo Safar <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Chitthi <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Tum Hi Aana <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Kinna Sona <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Baarish <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Toh Aagaye Hum <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Ik Vaari Aa <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Phir Chala <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Kisi Se Pyaar Ho Jaye <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Dil Beparwah <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Jubin/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Jubin/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Jubin/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Jubin/Audio/${index}.mp3`;//this is to start download button
