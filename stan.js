...
const music = new Audio ('Project1/Stan/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Amin <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Astagfirullah <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Basti Ka Hasti <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Kal hai Mera <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Broke Is A Joke <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Fckk Love <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Kal Hai Mera <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Mera Baap <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `One Day Uh <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Regret <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Shana Bann <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Snake <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Tadipaar <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Basti Ka Hasti <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Fckk Love <br><div class="subtitle">MC-Stan</div>`,
        poster: "Project1/Stan/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Stan/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Stan/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Stan/Audio/${index}.mp3`;//this is to start download button
