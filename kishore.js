...
const music = new Audio ('Project1/Kishore/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Bhole O Bhole <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Jiska Mujhe Tha Intezar <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Mere Samnewali Khidki <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Bachke Rehna Re Baba <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Gum Hai Kisi Ke  <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Janu Meri Jaan <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Pag Ghungroo Bandh <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Jai Jai Shiv Shankar <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Ek Main Aur Ek Tu <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Bheegi Bheegi Raton Mein <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Apni Toh Jaise <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Salam-E-Ishq <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Accha Toh Hum Chaltein <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Keh Doon Tumhe Ya  <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Jahan Teri Ye Nazar Hai <br><div class="subtitle">Kishore Kumar</div>`,
        poster: "Project1/Kishore/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Kishore/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Kishore/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Kishore/Audio/${index}.mp3`;//this is to start download button
