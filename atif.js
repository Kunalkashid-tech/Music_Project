...
const music = new Audio ('Project1/Atif/Audio/1.mp3');
//music.play();
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Atif/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Atif/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Atif/Audio/${index}.mp3`;//this is to start download button
