...
const music = new Audio ('Project1/Dhvani/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Vaste <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Tum Hi Aana <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Kinna Sona <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Mera Yaar <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Duniyaa <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Koka <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Sauda Khara Khara <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Mukhda Vekh Ke <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Rula Diya <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Baby Girl <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Na Ja Tu <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Jeetenge Hum <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Gallan Goriyan <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Dariyaganj <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Nachi Nachi <br><div class="subtitle">Dhvani Bhanushali</div>`,
        poster: "Project1/Dhvani/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Dhvani/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Dhvani/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Dhvani/Audio/${index}.mp3`;//this is to start download button
