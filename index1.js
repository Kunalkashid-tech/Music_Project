// this code is to add musi
 const music = new Audio ('Project1/Songs/1.mp3');
//music.play();
...
const songs = [

    {
        ...
        poster: "Project1/Images/1.jpg",
       
    },
    {
        id: '2',
        songName: `Where are you now <br><div class="subtitle">Iselin Solheim</div>`,
        poster: "Project1/Images/2.jpg",
       
    },
    {
        id: '3',
        songName:  `On and On <br><div class="subtitle">Daniel Levi</div>`,
        poster: "Project1/Images/3.jpg",
       
    },
    {
        id: '4',
        songName: `warriyo - Mortals <br><div class="subtitle">Mortals</div>`,
        poster: "Project1/Images/4.jpg",
       
    },
    {
        id: '5',
        songName: `Ertugrul Gazi <br><div class="subtitle">Ertugrul</div>`,
        poster: "Project1/Images/5.jpg",
       
    },
    {
        id: '6',
        songName: `Electronic Music <br><div class="subtitle">Electro</div>`,
        poster: "Project1/Images/6.jpg",
       
    },
    {
        id: '7',
        songName: `Agar Tum Sath Ho <br><div class="subtitle">Tamashaa</div>`,
        poster: "Project1/Images/7.jpg",
       
    },
    {
        id: '8',
        songName: `Suna Hai <br><div class="subtitle">Neha Kakkar</div>`,
        poster: "Project1/Images/8.jpg",
        
    },
    {
        id: '9',
        songName: `Dilbar <br><div class="subtitle">Satyamev Jayate</div>`,
        poster: "Project1/Images/9.jpg",
       
    },
    {
        id: '10',
        songName: `Duniya <br><div class="subtitle">Luka Chuppi</div>`,
        poster: "Project1/Images/10.jpg",
       
    },
    {
        id: '11',
        songName: `Lagdi Lahore Di <br><div class="subtitle">Street Dancer</div>`,
        poster: "Project1/Images/11.jpg",
       
    },
    {
        id: '12',
        songName: `Putt Jatt Da <br><div class="subtitle">Putt Jatt Da</div>`,
        poster: "Project1/Images/12.jpg",
        
    },
    {
        id: '13',
        songName: `Baarishein <br><div class="subtitle">Atif Aslam</div>`,
        poster: "Project1/Images/13.jpg",
       
    },
    {
        id: '14',
        songName: `Vaaste <br><div class="subtitle">Dhavni Bhanushali</div>`,
        poster: "Project1/Images/14.jpg",
       
    },
    {
        id: '15',
        songName: `Lut Gaye <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Images/15.jpg",
        
    },
    {
        id: '16',
        songName: `Tu Meri Jindagi Hai <br><div class="subtitle">Jubin Nautiyal</div>`,
        poster: "Project1/Images/16.jpg",
        
    },
    {
        id: '17',
        songName: `Batao Yaad Hai Tumko <br><div class="subtitle">Rahat Fateh Ali Khan</div>`,
        poster: "Project1/Images/17.jpg",
        
    },
    {
        id: '18',
        songName: `Mere Dhol Judaiyan <br><div class="subtitle">Ali Sethi Seha Gill</div>`,
        poster: "Project1/Images/18.jpg",
       
    },
    {
        id: '19',
        songName: `Eh Munde Pagal<br><div class="subtitle">Ap Dhillon</div>`,
        poster: "Project1/Images/19.jpg",
        
    },
    {
        id: '20',
        songName: `Dunny 82k <br><div class="subtitle">Ap Dhillon</div>`,
        poster: "Project1/Images/20.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Songs/${index}.mp3`;
      poster_master_play.src = `Project1/Images/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Songs/${index}.mp3`;//this is to start download button
