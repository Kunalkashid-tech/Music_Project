...
const music = new Audio ('Project1/Alan/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Blue <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Adventure Time <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Belivers <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Catch Me If You Can <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Extremes <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Hello World <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Lovesick <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Shut Up <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Somebody Like U <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Adventure Time <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Belivers <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Catch Me If You Can <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Extremes <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Hello World <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Lovesick <br><div class="subtitle">Alan Walkewr</div>`,
        poster: "Project1/Alan/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Alan/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Alan/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Alan/Audio/${index}.mp3`;//this is to start download button
