...
const music = new Audio ('Project1/Guru/Audio/1.mp3');
//music.play();
...
const songs = [

    {
        ...
        poster: "Project1/Guru/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Naach Meri Rani <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Teri Choriyan <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Surma Surma <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Main Deewana Tera <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Daaru Wargi <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Enni Soni <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Outfit <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Morni Banke <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Nachle Na <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `High Rated Gabru <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Kaun Nachdi <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Lagdi Hai Thai <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Ban Ja Rani <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Mehndi Wale Haath <br><div class="subtitle">Guru Randhawa</div>`,
        poster: "Project1/Guru/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Guru/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Guru/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Guru/Audio/${index}.mp3`;//this is to start download button
