...
const music = new Audio ('Project1/Honey/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Angreji Beat <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Brown Rang <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Chaar Bottle Vodka <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Chhote Chhote Peg <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Dheere Dheere <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Blue Eyes <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Dope Shope <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `One Bottle Down <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Lashkare <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Aankhon Aankhon <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Aata Majhi Satakli <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Beautiful <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Care Ni Karda <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Casanova <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `De Taali <br><div class="subtitle">Honey Singh</div>`,
        poster: "Project1/Honey/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Honey/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Honey/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Honey/Audio/${index}.mp3`;//this is to start download button
