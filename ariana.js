...
const music = new Audio ('Project1/Ariana/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '3',
        songName:  `Bang Bang <br><div class="subtitle">Ariana Grande</div>`,
        poster: "Project1/Ariana/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Dangerous <br><div class="subtitle">Ariana Grande</div>`,
        poster: "Project1/Ariana/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `34 + 35 <br><div class="subtitle">Ariana Grande</div>`,
    ...
    {
        id: '10',
        songName: `Stuck With You <br><div class="subtitle">Ariana Grande</div>`,
    ...
    {
        id: '14',
        songName: `Rain On Me <br><div class="subtitle">Ariana Grande</div>`,
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Ariana/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Ariana/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Ariana/Audio/${index}.mp3`;//this is to start download button
