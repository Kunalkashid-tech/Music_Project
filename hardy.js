...
const music = new Audio ('Project1/Hardy/Audio/1.mp3');
//music.play();
...
const songs = [
    ...
    {
        id: '1',
        songName: `Backbone <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/1.jpg",
       
    },
    {
        id: '2',
        songName: `Bijlee Bijlee <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/2.jpg",
       
    },
    {
        id: '3',
        songName:  `Dance Like <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/3.jpg",
       
    },
    {
        id: '4',
        songName: `Hornn Blow <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/4.jpg",
       
    },
    {
        id: '5',
        songName: `Jee Kar Da <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/5.jpg",
       
    },
    {
        id: '6',
        songName: `Joker <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/6.jpg",
       
    },
    {
        id: '7',
        songName: `Ki Kariye <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/7.jpg",
       
    },
    {
        id: '8',
        songName: `Kudiyan Lahore Diyan <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/8.jpg",
        
    },
    {
        id: '9',
        songName: `Kya Baat Ay <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/9.jpg",
       
    },
    {
        id: '10',
        songName: `Little Little <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/10.jpg",
       
    },
    {
        id: '11',
        songName: `Naah <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/11.jpg",
       
    },
    {
        id: '12',
        songName: `Soch <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/12.jpg",
        
    },
    {
        id: '13',
        songName: `Titliaan Warga <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/13.jpg",
       
    },
    {
        id: '14',
        songName: `Yaad Aati Hai <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/14.jpg",
       
    },
    {
        id: '15',
        songName: `Yaar Ni Miliyan <br><div class="subtitle">Hardy Sandhu</div>`,
        poster: "Project1/Hardy/Img/15.jpg",
...
Array.from(document.getElementsByClassName(' menuBtns')).forEach((element)=>{
  element.addEventListener('click',(element)=>{
   index = element.target.id;
       music.src = `Project1/Hardy/Audio/${index}.mp3`;
      poster_master_play.src = `Project1/Hardy/Img/${index}.jpg`;
      music.play();
      masterPlay.classList.remove('bi-play-fill');
      masterPlay.classList.add('bi-pause-fill');
       download_music.href = `Project1/Hardy/Audio/${index}.mp3`;//this is to start download button
