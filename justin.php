...
<head>
   ...
   width: 100%;
   height: 259px;
    background: url("Project1/Justine/justine.png");
...
<div class="master_play">
    ...
    <img src="Project1/Justine/Img/1.jpg" alt="alan" id="poster_master_play">  <!--to download and give another image-->
    <h5 id="title">
        On My Way
        <div class="subtitle">Sabrina Carpenter</div>
    </h5>
